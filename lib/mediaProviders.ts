...
export const mediaStatus = { speechToText: Boolean(process.env.GOOGLE_CLOUD_PROJECT && process.env.GOOGLE_APPLICATION_CREDENTIALS), gemini: Boolean(process.env.GEMINI_API_KEY), textToSpeech: Boolean(process.env.GOOGLE_CLOUD_PROJECT), voicePreservation: false, videoRendering: false, lipSync: false }
